...
class Resource(Enum):
    ...
    DOCKER_CONFIG_SAVED_TO_DISK = auto()

    VPN_HOST_PUBLIC_IP = auto()
    JURY_HOST_PUBLIC_IP = auto()
    BASTION_HOST_PUBLIC_IP = auto()
    CONTAINER_REGISTRY_HOST_PUBLIC_IP = auto()
    CONTAINER_REGISTRY_HOST_INTERNAL_IP = auto()
    VULNBOX_HOSTS_INTERNAL_IPS = auto()
    JURY_HOST_UP = auto()
    VPN_HOST_UP = auto()
    CONTAINER_REGISTRY_HOST_UP = auto()
    ALL_VULNBOX_HOSTS_UP = auto()
    VPN_HOST_CONFIGURED = auto()
    JURY_HOST_CONFIGURED = auto()
    ALL_VULNBOX_HOSTS_CONFIGURED = auto()
    CONTAINER_REGISTRY_HOST_CONFIGURED = auto()
    FORCAD_STARTED = auto()
